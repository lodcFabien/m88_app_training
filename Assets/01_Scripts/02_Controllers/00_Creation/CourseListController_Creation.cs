...
public class CourseListController_Creation : MonoBehaviour
{
    ...
    {
        CourseItemController_Creation newCourse = Instantiate(_courseItemPrefab, _courseItemContainer);
    ...
    private void ActionOnCourseClicked(CourseItemController_Creation clickedCourse)
    {
    ...
    public void LoadCourseListFromDatabase()
    {
